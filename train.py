...
class Trainer(object):
    ...
    def __init__(self,check_point='check_point',restored=False,ifsave=True,lr_alpha=0.5,lr_beta=0.5,lr_gamma=0.5,
        ...
        self.savename=str(self.learning_rate)+'_'+str(self.lr_alpha)+'_'+str(self.lr_beta)+'_'+str(self.lr_gamma)+'_'+str(Gloop)
...
#        with tf.variable_scope('drgan'):
    ...
    #------------
        ...
        # print 'size_noise',pose.shape.as_list(),noise.shape.as_list()
            ...
            output_de, _ = Nets.netG_deconder(sample_add_zp,self.output_channel)
    ...
    #     ------------
        # sample_valid, _ = Nets.netG_deconder(valid_add_zp, self.output_channel,reuse=reuse)
        #
        # return sample_valid
    ...
    def loss_drgan(self,predict_data,predict_data_logits,predict_fake,predict_fake_logits,labels=None,
                   pose_label=None,logits_r_id=None,logits_f_id=None,logits_pose_r=None,logits_pose_f=None):
    ...
    def train(self):
        ...
        with tf.Graph().as_default():
            ...
            with tf.name_scope('compute_loss'):
                ...
                Dloss=(ad_loss_real+ad_loss_fake)*self.lr_gamma
                Gloss=ad_loss_syn
                if self.losstype==1:
                    Dloss+=id_loss_real
                    Gloss+=id_loss_syn
            ...
            summary_train_lossG_syn = tf.summary.scalar('loss/syn_loss_g',ad_loss_syn)
