...
class Trainer(object):
    ...
    def _init_model(self):
        ...
        self.init_vars=self.varsg+self.vard_fr+self.varsd
    ...
    def _predict_drgan_multipie(self,reuse=False):
        ...
        self.real_poselogits=nets.Custom_netD_discriminator_psloss(self.batch_data,posenum=self.pose_c,reuse=reuse)
        ...
        self.fake1_poselogits=nets.Custom_netD_discriminator_psloss(self.output_syn1,posenum=self.pose_c,reuse=True)
        ...
        self.fake2_poselogits=nets.Custom_netD_discriminator_psloss(self.output_syn2,posenum=self.pose_c,reuse=True)
    ...
    def _loss_compute(self):#G:D 2:1
        ...
        self.g_loss =(self.lr_alpha)*(10*self.pixel_loss_f1+self.ad_loss_syn1+self.id_preserve_f1)+\
                     (1-self.lr_alpha)*(10*self.pixel_loss_f2+self.ad_loss_syn2+self.id_preserve_f2)
